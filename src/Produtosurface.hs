...
getProdutosurfaceR :: Handler Html
getProdutosurfaceR = defaultLayout $ do
    setTitle "Microsoft Surface"
        ...
        <div ."container">
            ...
            <div ."row">
                <div ."col-md-8">
                    <div ."row">
                        <div ."col-md-4">
                            <img src=@{StaticR img_surface_png} ."main-img">
                        <div ."col-md-8">
                            <h2>Microsoft Surface
                            <div ."price">R$2.628,71
                            <hr>
                            <p>Quantity:
