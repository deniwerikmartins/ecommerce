...
getProdutoxboxR :: Handler Html
getProdutoxboxR = defaultLayout $ do
    setTitle "Microsoft Xbox One"
        ...
        <div ."container">
            ...
            <div ."row">
                <div ."col-md-8">
                    <div ."row">
                        <div ."col-md-4">
                            <img src=@{StaticR img_xbox_png} ."main-img">
                        <div ."col-md-8">
                            <h2>Microsoft Xbox One
                            <div ."price">R$1.234,05
                            <hr>
                            <p>Quantity:
