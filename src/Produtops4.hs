...
getProdutops4R :: Handler Html
getProdutops4R = defaultLayout $ do
    setTitle "Sony Playstation 4"
        ...
        <div ."container">
            ...
            <div ."row">
                <div ."col-md-8">
                    <div ."row">
                        <div ."col-md-4">
                            <img src=@{StaticR img_ps4_png} ."main-img">
                        <div ."col-md-8">
                            <h2>Sony Playstation 4
                            <div ."price">R$4.000,00
                            <hr>
                            <p>Quantity:
